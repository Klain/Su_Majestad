...
- Modo desarrollador como base de datos visual con pestañas de eventos, familias, actores, datos del juego y validación navegable.
- Sin dependencias y sin build step.


## Modo desarrollador

El Modo desarrollador es una base de datos visual compacta para crear contenido sin editar JSON como interfaz principal. Incluye pestañas para Eventos, Familias, Actores, Datos del juego y Validación. La pantalla mantiene una barra de acciones global para volver al menú, importar/exportar la base de datos versionada, guardar/cargar borrador local y validar todo.
...
- Diseñar un flujo seguro para editar o regenerar el catálogo unificado cuando el contenido crezca.
...
## v0.7.1 - Limpieza conservadora

- Elimina copias históricas del catálogo modular que ya no se cargaban desde `index.html`.
- Refuerza validaciones del editor para recursos, outcomes y diferidos.
- Mantiene compatibilidad con guardados recientes y aliases legacy.
