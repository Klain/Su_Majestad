registerEvents([
  ...
  ], { family: "crime", families: ["crime", "army", "corruption"], weight: 1.05 }),
  ...
  ], { family: "crime", families: ["crime", "army", "people"], weight: 1 }),
  ...
  ], { family: "crime", families: ["crime", "corruption"], weight: 1 }),
  ...
  ], { family: "army", families: ["army", "people", "church"], weight: 0.95 }),
  ...
  ], { family: "crime", families: ["crime", "nobility"], weight: 0.85 }),
  ...
  ], { family: "crime", families: ["crime", "commerce", "smuggling"], weight: 1 }),
  ...
  ], { kind: "consequence", family: "crime", requiresTags: ["ignored_watch_bribes"] }),
  ...
  ], { kind: "consequence", family: "crime", requiresTags: ["bandits_reformed"] }),
  ...
  ], { kind: "consequence", family: "crime", issue: { id: "jail-corruption" } }),
  ...
  ], { kind: "consequence", family: "crime", requiresTags: ["salt_route_followed"] }),
