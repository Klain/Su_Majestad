registerEvents([
  ...
  ], { family: "commerce", families: ["commerce", "army"], weight: 1.1 }),
  ...
  ], { family: "commerce", families: ["commerce", "crime"], weight: 1 }),
  ...
  ], { family: "commerce", families: ["commerce", "army", "people"], weight: 1 }),
  ...
  ], { family: "people", families: ["people", "commerce", "shortage"], weight: 1.15 }),
  ...
  ], { family: "commerce", families: ["commerce", "food", "people"], weight: 0.95 }),
  ...
  ], { family: "people", families: ["people", "commerce", "corruption"], weight: 1.05 }),
  ...
  ], { family: "people", families: ["people", "commerce", "public_works"], weight: 1 }),
  ...
  ], { family: "commerce", families: ["commerce", "crime", "people"], weight: 1 }),
  ...
  ], { family: "people", families: ["people", "commerce", "church"], weight: 0.95 }),
  ...
  ], { family: "commerce", families: ["commerce", "people", "shortage"], weight: 1.05 }),
  ...
  ], { family: "people", families: ["people", "disease", "public_works"], weight: 1 }),
  ...
  ], { family: "commerce", families: ["commerce", "nobility"], weight: 0.9 }),
  ...
  ], { family: "people", families: ["people", "commerce"], weight: 0.85 }),
  ...
  ], { family: "commerce", families: ["commerce", "public_works"], weight: 0.95 }),
  ...
  ], { kind: "consequence", family: "commerce", families: ["commerce", "crime"] }),
  ...
  ], { kind: "consequence", family: "commerce" }),
  ...
  ], { kind: "consequence", family: "commerce", requiresTags: ["merchant_debt"] }),
  ...
  ], { kind: "consequence", family: "disease", families: ["disease", "food"] }),
